<%@ Page Title="Home Teacher Add or Update" Language="VB" MasterPageFile="~/MasterPage2.master" AutoEventWireup="false" CodeFile="Home_teacher_add.aspx.vb" Inherits="Home_teacher_add" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="height: 648px">
        <table style="width: 100%; height: 1128px">
            <tr>
                <td colspan="6" align="center" 
                
                    style="background-position: -96px -52px; background-image: url('images/bg img/banner_worksheets-banner.jpg'); height: 158px;">
                    &nbsp;</td>
            </tr>
            <tr>
                ...
                <td colspan="4" style="height: 37px">
                    <marquee behavior="alternate">&nbsp;&nbsp;&nbsp;&nbsp; <span style="vertical-align: middle; color :red; font-size:20"><b>Home Teacher</b></span></marquee></td>
            ...
            <tr>
                ...
                <td style="width: 389px; height: 46px;">
                    <asp:DropDownList ID="DropDownList2" runat="server" 
                        Height="16px" Width="175px" Visible="False" DataSourceID="SqlDataSource1" 
                        DataTextField="tid" DataValueField="tid">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                        SelectCommand="SELECT * FROM [hometec]"></asp:SqlDataSource>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td align="right" style="font-size: 20px; width: 60px;">
                    &nbsp;</td>
                <td style="width: 389px">
                    <asp:FileUpload ID="FileUpload1" runat="server" Height="32px" Width="257px" />
                    <br />
