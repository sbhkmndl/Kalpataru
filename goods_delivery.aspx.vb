...
Partial Class goods_delivery
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            vl1 = Val(DropDownList2.SelectedValue.ToString)
            vl2 = Val(DropDownList3.SelectedValue.ToString)
            vl3 = vl1 * vl2
            Label14.Text = vl3.ToString
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Label24.Text = GridView1.SelectedRow.Cells(2).Text
        Label25.Text = GridView1.SelectedRow.Cells(1).Text
        Label26.Text = GridView1.SelectedRow.Cells(3).Text
        Label27.Text = GridView1.SelectedRow.Cells(5).Text
    End Sub
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            con.Open()
            Dim cmd As SqlCommand
            cmd = New SqlCommand("select * from gddeliver where gdid='" + Label25.Text + "'", con)
            Dim dr As SqlDataReader
            dr = cmd.ExecuteReader
            If dr.Read Then
                Session("gdsid") = dr(0).ToString
                Session("gdsname") = dr(1).ToString
                Session("gdspic") = dr(2).ToString
                Session("gdstnum") = dr(3).ToString
                Session("gdsmob") = dr(7).ToString
                Session("gdsgend") = dr(8).ToString
                Session("mail") = dr(9).ToString
                Session("gdsarea") = dr(5).ToString
            End If
        ...
        Try
            ...
            Session("blno") = str2
            Session("ordtyp") = "gooddelivery"
            Session("orddat") = DateTime.Now.ToString("dd-MM-yyyy")
            Session("ordtme") = DateTime.Now.ToString("hh:mm tt")
            Session("Price") = Label14.Text
            Session("gdsdistance") = DropDownList2.SelectedValue.ToString
            Session("gdspackwgt") = DropDownList3.SelectedValue.ToString
