...
Partial Class Technician
    ...
    Protected Sub GridView1_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridView1.SelectedIndexChanged
        ...
        Label18.Text = GridView1.SelectedRow.Cells(2).Text.ToString.Trim()
        Label19.Text = GridView1.SelectedRow.Cells(1).Text.ToString.Trim()
        Label21.Text = GridView1.SelectedRow.Cells(3).Text.ToString.Trim()
        Label22.Text = GridView1.SelectedRow.Cells(5).Text.ToString.Trim()
        Label20.Text = DropDownList3.Text
    End Sub
    ...
    Protected Sub Button2_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button2.Click
        Try
            con.Open()
            Dim cmd As SqlCommand
            cmd = New SqlCommand("select * from techn where tcid='" + Label19.Text + "'", con)
            Dim dr As SqlDataReader
            dr = cmd.ExecuteReader
            If dr.Read Then
                Session("tecnid") = dr(0).ToString
                Session("tecnname") = dr(2).ToString
                Session("tecnpic") = dr(4).ToString
                Session("tecnmob") = dr(6).ToString
                Session("tecngend") = dr(5).ToString
        ...
        Try
            ...
            perposee = "Technician for " & Label20.Text
