...
Partial Class evntmngbill
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label42.Text = Session("evntocetn").ToString
        Label45.Text = Session("evntdate").ToString
        Label46.Text = Session("eventtime").ToString

        Label12.Text = Session("evid").ToString
        Label13.Text = Session("evtname").ToString
        Label14.Text = Session("evcntno").ToString
        Label15.Text = Session("evntmemno").ToString
