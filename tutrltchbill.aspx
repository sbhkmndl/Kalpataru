<%@ Page Language="VB" AutoEventWireup="false" CodeFile="tutrltchbill.aspx.vb" Inherits="tutrltchbill" %>
...
<div style="height: 1385px">
    ...
    <bunch of html>
    <asp:Panel ID="Panel1" runat="server" Height="1355px">
        <table class="style6">
            <tr>
                    ...
                    <table align="center" class="style55">
                        ...
                        <tr>
                            ...
                            <td align="right" class="style70">
                                STUDENT NAME</td>
                            <td align="center">
                                <asp:Label ID="Label30" runat="server" ForeColor="Black"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" class="style68">
                            ...
                            <td align="right" class="style70">
                                SUBJECT</td>
                            <td align="center">
                                <asp:Label ID="Label31" runat="server" ForeColor="Black"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" class="style68">
                        ...
                        <tr>
                            ...
                            <td align="right" class="style70">
                                TIME</td>
                            <td align="center">
                                <asp:Label ID="Label33" runat="server" ForeColor="Black"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" class="style68">
                        ...
                        <tr>
                            ...
                            <td align="left" class="style69">
                                &nbsp;</td>
                            <td align="right" class="style70">
                                <asp:Label ID="Label20" runat="server" ForeColor="Black" Text="PAID THROUGH"></asp:Label>
                            </td>
                            <td align="center">
