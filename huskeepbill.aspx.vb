...
Partial Class huskeepbill
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label39.Text = Session("hsktime").ToString

        Label12.Text = Session("hksid").ToString
        Label13.Text = Session("hkdname").ToString
        Label14.Text = Session("hksmob").ToString
        Label15.Text = Session("hksgend").ToString
        Label25.Text = Session("orddat").ToString
        Label26.Text = Session("ordtme").ToString
        Image2.ImageUrl = Session("hkspic").ToString
