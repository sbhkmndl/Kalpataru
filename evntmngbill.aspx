<%@ Page Language="VB" AutoEventWireup="false" CodeFile="evntmngbill.aspx.vb" Inherits="evntmngbill" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Event Management Bill</title>
    <style type="text/css">
...
<div style="height: 1143px">
    ...
    <bunch of html>
    <asp:Panel ID="Panel1" runat="server" Height="1118px">
        <table class="style6">
            <tr>
            ...
            <tr>
                <td align="center" class="style38" colspan="4" 
                    ...
                    Hire a Event Management Team</td>
            </tr>
            <tr>
                <td class="style44" colspan="4" 
                    ...
                    <table align="center" class="style55">
                        ...
                        <tr>
                            ...
                            <td align="right" class="style70">
                                <asp:Label ID="Label37" runat="server" ForeColor="Black" Text="OCCATION"></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="Label42" runat="server" ForeColor="Black"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" class="style68">
                        ...
                        <tr>
                            ...
                            <td align="right" class="style70">
                                <asp:Label ID="Label38" runat="server" ForeColor="Black" Text="PAID THROUGH"></asp:Label>
                            </td>
                            <td align="center">
                        ...
                        <tr>
                            ...
                            <td align="right" class="style70">
                                <asp:Label ID="Label39" runat="server" ForeColor="Black" Text="EVENT DATE"></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="Label45" runat="server" ForeColor="Black"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" class="style68">
                            ...
                            <td align="left" class="style69">
                                &nbsp;</td>
                            <td align="right" class="style70">
                                <asp:Label ID="Label27" runat="server" ForeColor="Black" Text="EVENT TIME"></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="Label46" runat="server" ForeColor="Black"></asp:Label>
                            </td>
                        </tr>
                    </table>
                </td>
