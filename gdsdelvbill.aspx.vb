...
Partial Class gdsdelvbill
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label34.Text = Session("gdsarea").ToString
        Label47.Text = Session("gdsdistance").ToString
        Label48.Text = Session("gdspackwgt").ToString

        Label12.Text = Session("gdsid").ToString
        Label13.Text = Session("gdsname").ToString
        Label14.Text = Session("gdsmob").ToString
        Label15.Text = Session("gdsgend").ToString
        Label20.Text = Session("gdstnum").ToString
        Label25.Text = Session("orddat").ToString
        Label26.Text = Session("ordtme").ToString
        Image2.ImageUrl = Session("gdspic").ToString
    End Sub
