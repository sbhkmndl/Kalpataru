...
Partial Class admnprof
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            cmd = New SqlCommand("select * from aadmin where uid='" + uihld + "'", con)
    ...
    Protected Sub ImageButton2_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImageButton2.Click
        ...
        Try
            ...
            Dim cmd As SqlCommand
            If fileName <> "" Then
                cmd = New SqlCommand("update aadmin set uname =@uname, uage =@uage, uaddr =@uaddr, upic =@upic, ugen =@ugen, umob =@umob, umail =@umail where uid='" + Label4.Text + "'", con)
            Else
                cmd = New SqlCommand("update aadmin set uname =@uname, uage =@uage, uaddr =@uaddr, ugen =@ugen, umob =@umob, umail =@umail where uid='" + Label4.Text + "'", con)
            End If
