...
Partial Class tutrltchbill
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label30.Text = Session("tutorstdnm").ToString
        Label31.Text = Session("tutorsbj").ToString
        Label32.Text = Session("tutorclss").ToString
        Label33.Text = Session("tutortime").ToString
        Label34.Text = Session("tutorrdloc").ToString

        Label12.Text = Session("tutortid").ToString
        Label13.Text = Session("tutorname").ToString
        Label14.Text = Session("tutormob").ToString
        Label15.Text = Session("tutorgend").ToString
        Label25.Text = Session("orddat").ToString
        Label26.Text = Session("ordtme").ToString
        Image2.ImageUrl = Session("tutorpic").ToString
