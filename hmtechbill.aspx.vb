...
Partial Class hmtechbill
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Label35.Text = Session("hmtsbj").ToString
        Label36.Text = Session("hmtclss").ToString
        Label40.Text = Session("hmtstdnm").ToString
        Label41.Text = Session("mhttime").ToString

        Label12.Text = Session("hmtid").ToString
        Label13.Text = Session("hmtname").ToString
        Label14.Text = Session("hmtmob").ToString
        Label15.Text = Session("hmtgend").ToString
        Label25.Text = Session("orddat").ToString
        Label26.Text = Session("ordtme").ToString
        Image2.ImageUrl = Session("hmtpic").ToString
